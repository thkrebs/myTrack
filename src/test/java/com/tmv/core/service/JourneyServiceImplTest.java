...
class JourneyServiceImplTest {
    ...
    void updateJourney_existingJourney_updatedSuccessfully() {
        ...
        newJourneyData.setTrackedByImeis(Set.of(new Imei("12345", true, null, null, null, testUser, "", "", true)));
    ...
    void updateJourney_journeyNotFound_createsNewJourney() {
        ...
        newJourneyData.setStartDate(dtStart);
        newJourneyData.setEndDate(dtEnd);
        newJourneyData.setTrackedByImeis(Set.of(new Imei("67890", true, null, null, null, testUser, "", "", true)));
    ...
    void startJourney_success() {
        ...
        journey.setTrackedByImeis(Set.of(new Imei("12345", true, null, null, null, testUser, "", "", true)));
    ...
    void startJourney_noActiveImeis_throwsConstraintViolationException() {
        ...
        Long journeyId = 1L;
        Journey journey = new Journey();
        journey.setTrackedByImeis(Set.of(new Imei("12345", false, null, null, null, testUser, "", "", true)));
        Mockito.when(journeyRepository.findById(journeyId)).thenReturn(Optional.of(journey));
    ...
    void createNewParkSpotForJourneyNoNearBySpot_success() {
        ...
        Imei imei = new Imei("12345", true, null, null, null, testUser, "", "", true);
    ...
    void testDetermineActiveImei_singleActive() {
        ...
        journey.setTrackedByImeis(Set.of(
                new Imei("12345", false,null,null,null, testUser, "", "", true),
                new Imei("67890", true, null, null,null, testUser, "", "", true)
        ));
    ...
    void testDetermineActiveImei_multipleActive() {
        ...
        Journey journey = new Journey();
        journey.setTrackedByImeis(Set.of(
                new Imei("12345", true,null,null,null, testUser, "", "",true),
                new Imei("67890", true, null, null, null, testUser, "", "", true)
        ));
    ...
    void testDetermineActiveImei_noActive() {
        ...
        journey.setTrackedByImeis(Set.of(
                new Imei("12345", false,null,null,null, testUser, "", "", true),
                new Imei("67890", false, null, null, null, testUser, "", "", true)
        ));
