...
public interface MapStructMapper {
    ...
    @Mapping(target = "id", expression = "java(new com.tmv.core.model.OvernightParkingId(overnightParkingDTO.getJourneyId(), overnightParkingDTO.getParkSpotId()))")
    ...
    default void mapOvernightParkingsToParkSpots(Journey journey, @MappingTarget JourneyDTO journeyDTO) {
        journeyDTO.setParkSpots(extractParkSpotsFromOvernightParkings(journey.getOvernightParkings().stream().toList()));
    }
